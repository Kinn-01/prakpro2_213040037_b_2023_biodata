...
// Class HapusActionListener yang Implementasi ActionListener untuk button Hapus
public class HapusActionListener implements ActionListener {
  ...
  // Method HapusActionListener untuk menyimpan nilai biodataFrame dan biodataDao
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    // Jika row atau column bernilai -1
    if (row == -1 || column == -1) {
      // Panggil method showAlertFailed pada biodataFrame dengan parameter "dihapus"
      this.biodataFrame.showAlertFailed("dihapus");
      return;
    } else {
      // Variable newValue tipe String untuk menyimpan nilai dari table yang diedit
      ...
      // Variable col berisi string kosong untuk menyimpan nama kolom yang dipilih
      String col = "";
