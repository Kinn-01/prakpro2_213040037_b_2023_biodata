...
// Class CloseWindowActionListener yang Implementasi dari WindowAdapter untuk button Close
public class CloseWindowActionListener implements WindowListener {
	...
	public void windowClosing(WindowEvent e) {
		...
		// Jika confirmation nilai nya YES_OPTION
		if (confirmation == JOptionPane.YES_OPTION) {
			// Maka Keluar dari aplikasi
			System.exit(0);
		} else {
			// Jika batal keluar, kembalikan frame ke kondisi awalan
