...
// Class SimpanUbahActionListener yang Implementasi ActionListener untuk button Simpan
public class SimpanUbahActionListener implements ActionListener {
    ...
    // Variable id untuk menyimpan nilai id
    private String id; 

    // Method SimpanUbahActionListener untuk menyimpan nilai biodataFrame, biodataDao, dan id
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (confirmation == 0) {
            ...
            // Set id biodata dengan nilai id
